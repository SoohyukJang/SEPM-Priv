        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              <img className="h-10 w-auto" src="/images/Logo.png" alt="NutriGen Bot" />
              <span className="ml-2 text-xl font-bold text-gray-900">NutriGen Bot</span>
            </Link>
            <p className="mt-2 text-sm text-gray-500">
              Your personal nutrition assistant for healthy eating.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex">
                ...
                <span className="ml-3 text-base text-gray-500">
                  RMIT Vietnam, 702 Nguyen Van Linh, District 7, Ho Chi Minh City, Vietnam
                </span>
              </li>
            </ul>
          </div>
